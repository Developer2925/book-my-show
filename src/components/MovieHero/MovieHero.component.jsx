            ...
            <div className="relative hidden lg:block" style={{ height: "30rem" }}>
                ...
                <div className="absolute z-6 w-full h-96 left-24 top-12 flex gap-8 items-center">
                    ...
                    <div className='w-full'>
                        ...
                        <div >
                            <button className="bg-bgBtn-1 text-white flex items-center justify-center rounded-md w-52 py-3 mt-4" onClick={launchRazorPay}>Book Tickets</button>
                        </div>
                    </div>
                </div>
